    ...
    if request.method == "POST":
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f'Congratulations! You sold {s_item_object.name} for ₹{s_item_object.price} back to the market!', category='success')
...
def register_page():
    ...
    if form.validate_on_submit():
        ...
        flash(f'Success! Account created successfully. You are now logged in as: {user_to_create.username}', category='success')
        return redirect(url_for('market_page'))
